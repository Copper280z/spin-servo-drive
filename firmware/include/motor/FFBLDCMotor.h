...
/**
 BLDC motor class
*/
class FFBLDCMotor: public FOCMotor
{
  public:
    float Ts = 1.0f/14000.0f;
    enum CustomMCType:uint8_t {angle_nocascade = 42};
    float feed_forward_accel = 0;
    float inertia = 0;
    float friction = 0;
    float VdFF = 0;
    float VqFF = 0;
    ...
    DQCurrent_s current_prev{.d=0,.q=0};
    DQVoltage_s Vbemf{.d=0, .q=0};
    /**
     ...
     */ 
    FFBLDCMotor(int pp,  float R = NOT_SET, float KV = NOT_SET, float L = NOT_SET);
    ...
    */
    ...
    float Ua, Ub, Uc, Uq, Ud;//!< Current phase voltages Ua,Ub and Uc set to motor
